...
public class OrderController {
    ...
    public Page4Navigator<Order> list(@RequestParam(value = "start",defaultValue = "0") int start,@RequestParam(value = "size",defaultValue = "5")int size) throws  Exception{
        ...
        Page4Navigator<Order> page = this.orderService.list(start,size,5);
        this.orderItemService.fill(page.getContent());
        this.orderService.removeOrderFromOrderItem(page.getContent());
        return page;
    }
